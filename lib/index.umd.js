  ...
  methods: {
    ...
    _getActiveInfo: function _getActiveInfo(tableData, columns, key) {
      ...
      if (row) {
        ...
        if (column) {
          var _this$_getColumnByRow4 = this._getColumnByRowIndex(row.data, column.property),
    ...
    _tabActiveCell: function _tabActiveCell(offsetRow, offsetColumn) {
      if (this.configs.tabToActive) {
        var _this$_getColumnByRow5 = this._getColumnByRowIndex(offsetRow.data, offsetColumn.property),
    ...
    _toActiveRow: function _toActiveRow(record, prop) {
      ...
      var _this$_getColumnByRow6 = this._getColumnByRowIndex(record, prop),
          row = _this$_getColumnByRow6.row,
          column = _this$_getColumnByRow6.column,
...
var editable_component = normalizeComponent(
  ...
  editablevue_type_template_id_9fc36b40_render,
  editablevue_type_template_id_9fc36b40_staticRenderFns,
  false,
  null,
  null,
  null
