...
const RoleVO = require('./role/model')
const roleList = template(require('./role/list.json'))
DELETE('/api/role/delete/{id}', MockUtil.removeByPathVariable(roleList, RoleVO, 'id'))
...
const UserVO = require('./user/model')
const userList = template(require('./user/list.json'))
DELETE('/api/user/delete/{id}', MockUtil.removeByPathVariable(userList, UserVO, 'id'))
...
const FileVO = require('./file/model')
const fileList = template(require('./file/list.json'))
DELETE('/api/file/delete/{id}', MockUtil.removeByPathVariable(fileList, FileVO, 'id'))
