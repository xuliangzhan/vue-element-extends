...
// CONCATENATED MODULE: ./packages/editable/src/editable.vue?vue&type=template&id=07cfbdac&
...
/* harmony default export */ var editablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    hasInsertRow: function hasInsertRow(record) {
      var row = this.datas.find(function (item) {
        return item.data === record;
      });
...
var editable_column_component = normalizeComponent(
  ...
  editable_columnvue_type_template_id_720e4539_render,
  editable_columnvue_type_template_id_720e4539_staticRenderFns,
  false,
  null,
  null,
  null
