...
// CONCATENATED MODULE: ./packages/table/src/table.vue?vue&type=template&id=40b9efb6&
...
var ScrollHandle = {
  reload: function reload() {
    return function (isReload) {
      ...
      return this.$nextTick().then(function () {
        _this._computeScroll(); // 如果重新加载表格，索引重新初始化
        ...
        return _this.$nextTick().then(function () {
          // 如果重新加载表格，滚动位置重新初始化
          if (!isReload) {
            _this.bodyWrapperElem.scrollTop = 0;
            _this.bodyWrapperElem.scrollLeft = 0;
          }
        });
      });
    };
  ...
  bind: function bind() {
    return function () {
      ...
      return this.$nextTick().then(function () {
        // 绑定事件，生成对应元素
        _this2.headerWrapperElem = _this2.$refs.refElTable.$el.querySelector('.el-table__header-wrapper');
        _this2.bodyWrapperElem = _this2.$refs.refElTable.$el.querySelector('.el-table__body-wrapper');
        _this2.tableElem = _this2.bodyWrapperElem.querySelector('.el-table__body');
        _this2.scrollTopSpaceElem = document.createElement('div');
        _this2.scrollTopSpaceElem.className = 'elx-scroll_top-pace';
        _this2.scrollBottomSpaceElem = document.createElement('div');
        _this2.scrollBottomSpaceElem.className = 'elx-scroll_bottom-pace';

        _this2.bodyWrapperElem.insertBefore(_this2.scrollTopSpaceElem, _this2.tableElem);

        _this2.bodyWrapperElem.insertBefore(_this2.scrollBottomSpaceElem, _this2.tableElem.nextSibling);

        _this2.bodyWrapperElem.addEventListener('scroll', _this2._scrollEvent, false);
      });
    };
  },
      ...
      if (isRender) {
        ...
        if (toVisibleStart !== visibleStart) {
          ...
          this.$nextTick().then(function () {
            // 渲染完成复原最后位置，保持滚动位置不变
            _this3.bodyWrapperElem.scrollTop = scrollTop;
          });
        }
      }
  ...
  compute: function compute(size) {
    var defSize = util.browse.msie ? size / 2 : size;
    return function () {
      if (this.scrollLoad) {
...
// CONCATENATED MODULE: ./packages/editable/src/define.js
...
/* harmony default export */ var define = (DefineHandle);
...
/* harmony default export */ var tablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    _computeScroll: src_scroll.compute(10),
...
var table_column_component = normalizeComponent(
  ...
  table_columnvue_type_template_id_2c3113ae_render,
  table_columnvue_type_template_id_2c3113ae_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var editablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    _cellHandleEvent: function _cellHandleEvent(type, row, column, cell, event) {
      ...
      // 触发顺序 -> clear -> active
      setTimeout(function () {
        if (_this11.configs.trigger !== 'manual' && util.hasClass(cell, 'elx_edit') && (row.editActive ? _this11.configs.mode === 'row' && _this11.lastActive ? _this11.lastActive.column.property !== column.property : _this11.configs.mode === 'cell' && row.editActive !== column.property : true)) {
    ...
    _unbindScrollEvent: src_scroll.unbind(),
    _scrollEvent: src_scroll.scroll(),
    _computeScroll: src_scroll.compute(5),
...
var editable_component = normalizeComponent(
  ...
  editablevue_type_template_id_8921b162_render,
  editablevue_type_template_id_8921b162_staticRenderFns,
  false,
  null,
  null,
  null
...
var editable_column_component = normalizeComponent(
  ...
  editable_columnvue_type_template_id_303ce9c4_render,
  editable_columnvue_type_template_id_303ce9c4_staticRenderFns,
  false,
  null,
  null,
  null
