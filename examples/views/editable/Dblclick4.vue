<template>
  <div v-loading="loading">
    ...
    <el-form ref="tableform" class="dblclick-table4-form" size="mini" :inline="true" :model="formData">
    ...
    <div class="dblclick-table4-oper">
    ...
    <elx-editable
      ...
      <elx-editable-column prop="describe" label="备注" show-overflow-tooltip :edit-render="{name: 'ElInput', attrs: {type: 'textarea', autosize: {minRows: 1, maxRows: 4}}}"></elx-editable-column>
    ...
    <el-pagination
      class="dblclick-table4-pagination"
...
<style>
.dblclick-table4-oper {
  margin-bottom: 18px;
}
.dblclick-table4 .delete-row {
  color: #f56c6c;
  text-decoration: line-through;
}
.dblclick-table4-pagination {
