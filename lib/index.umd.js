          ...
          switch (code) {
            ...
            case 'ROW_INSERT_ACTIVE':
              this.insertAt(null, row.data).then(function (_ref16) {
                var _row = _ref16._row;
                return _this19._toActiveRow(_row.data, column.property);
              });
              break;
...
var editable_component = normalizeComponent(
  ...
  editablevue_type_template_id_300f5b5e_render,
  editablevue_type_template_id_300f5b5e_staticRenderFns,
  false,
  null,
  null,
  null
