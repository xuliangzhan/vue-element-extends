<template>
  <div id="app">
    <div class="apimenu-header">
       <a href="https://github.com/xuliangzhan/vue-element-extends">查看代码</a>
      <div class="apimenu-row">
        ...
        <router-link class="apimenu-link" :to="{name: 'EditableManual7'}" replace>行编辑+行操作+多个表格</router-link>
      </div>
      <div class="apimenu-row">
      ...
      <div class="apimenu-row">
        ...
        <router-link class="apimenu-link" :to="{name: 'EditableDblclick7'}" replace>个性化列+校验+标记删除+导出数据</router-link>
      </div>
      <div class="apimenu-row">
        ...
        <router-link class="apimenu-link" :to="{name: 'EditableExcel6'}" replace>校验+排序+筛选+个性化列+导出数据+方向键切换</router-link>
      </div>
    </div>
    <router-view/>
  </div>
