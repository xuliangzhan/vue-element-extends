  ...
  <div v-loading="loading">
    ...
    <el-editable
      ...
      <el-editable-column label="基本信息" group>
        <el-editable-column prop="name" label="名字" min-width="200" show-overflow-tooltip :edit-render="{name: 'ElInput'}"></el-editable-column>
        <el-editable-column prop="sex" label="性别" min-width="160" :edit-render="{name: 'ElSelect', options: sexList}"></el-editable-column>
      </el-editable-column>
      <el-editable-column label="重要信息" group>
      ...
      <el-editable-column label="其他信息" group>
        ...
        <el-editable-column label="特殊信息" group>
          ...
          <el-editable-column prop="flag" label="是否启用" width="160" :edit-render="{name: 'ElSwitch', type: 'visible'}"></el-editable-column>
        </el-editable-column>
      </el-editable-column>
...
.click-table5.editable .editable-row.new-insert,
.click-table5.editable .editable-row.new-insert:hover>td {
