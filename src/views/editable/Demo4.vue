<template>
  <div v-loading="loading">
    ...
    <el-editable ref="editable" height="440" stripe border @select="selectEvent" size="small" @current-change="currentChangeEvent" :editConfig="{trigger: 'dblclick', mode: 'row', showIcon: true, showStatus: true}">
