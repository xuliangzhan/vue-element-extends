...
// CONCATENATED MODULE: ./packages/table/src/table.vue?vue&type=template&id=39c43bcc&
  ...
  methods: {
    ...
    _bindScrollEvent: function _bindScrollEvent() {
      ...
      return this.$nextTick().then(function () {
        ...
        _this3.scrollWrapperElem.addEventListener('scroll', _this3._scrollEvent, false);
    ...
    // 滚动条拖动处理
    _scrollEvent: external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.throttle(function (evnt) {
    ...
    _updateStyle: function _updateStyle() {
      if (this.scrollLoad) {
        ...
        this.scrollBodyElem.style.height = "".concat(this.data.length * this.rowHeight + (this.bodyWrapperElem.clientHeight - this.configs.size * this.rowHeight), "px");
...
var table_column_component = normalizeComponent(
  ...
  table_columnvue_type_template_id_5c08fa74_render,
  table_columnvue_type_template_id_5c08fa74_staticRenderFns,
  false,
  null,
  null,
  null
  ...
  methods: {
    ...
    _bindScrollEvent: function _bindScrollEvent() {
      ...
      return this.$nextTick().then(function () {
        ...
        _this8.scrollWrapperElem.addEventListener('scroll', _this8._scrollEvent, false);
...
var editable_component = normalizeComponent(
  ...
  editablevue_type_template_id_cd7d7ff6_render,
  editablevue_type_template_id_cd7d7ff6_staticRenderFns,
  false,
  null,
  null,
  null
...
var editable_column_component = normalizeComponent(
  ...
  editable_columnvue_type_template_id_0536181a_render,
  editable_columnvue_type_template_id_0536181a_staticRenderFns,
  false,
  null,
  null,
  null
