  ...
  reload() {
    return function (isReload) {
      return this.$nextTick().then(() => {
        this._computeScroll(); // 如果重新加载表格，索引重新初始化
...
var editable_component = normalizeComponent(
  ...
  editablevue_type_template_id_d4f9e104_render,
  editablevue_type_template_id_d4f9e104_staticRenderFns,
  false,
  null,
  null,
  null
