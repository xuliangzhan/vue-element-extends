...
.excel-table3 .el-table__body .elx-editable-row>td {
  cursor: cell;
}
.excel-table3 .el-table__header th,
.excel-table3 .el-table__body .elx-editable-row>td:first-child,
.excel-table3 .el-table__body .elx-editable-row:hover>td:first-child {
  background-color: #f5f5f5;
}
.excel-table3 .el-table__body .elx-editable-row>td:first-child {
  cursor: default;
}
.excel-table3 .el-table__body .elx-editable-row:hover>td {
  background-color: inherit;
}
.excel-table3 .el-table__body .elx-editable-row>td.elx_checked {
  border: 1px solid #217346;
}
.excel-table3 .el-table__body .elx-editable-row>td .cell {
  width: 100% !important;
  line-height: 30px;
  padding: 0 3px;
}
.excel-table3 .el-table__body .elx-editable-row>td.elx_checked .cell {
  padding: 0 2px;
  line-height: 28px;
}
.excel-table3 .el-table__body .elx-editable-row>td.elx_active .cell {
  padding: 0;
}
.excel-table3 .el-table__body .elx-editable-row>td .cell,
.excel-table3 .el-table__body .elx-editable-row>td .cell .el-input,
.excel-table3 .el-table__body .elx-editable-row>td .cell .el-input__inner {
  height: 100%;
}
.excel-table3 .el-table__body .elx-editable-row>td .cell .el-input__inner {
  border-radius: 0;
