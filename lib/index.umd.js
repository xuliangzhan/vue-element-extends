...
// CONCATENATED MODULE: ./packages/table/src/table.vue?vue&type=template&id=3fe80e78&
  ...
  methods: {
    ...
    _reloadScrollData: function _reloadScrollData() {
      ...
      return this.$nextTick().then(function () {
        _this2._computeScroll();

        _this2.bodyWrapperElem.scrollTop = 0;
        _this2.bodyWrapperElem.scrollLeft = 0;
      });
    },
    _bindScrollEvent: function _bindScrollEvent() {
      ...
      return this.$nextTick().then(function () {
        ...
        _this3.scrollTopSpaceElem = document.createElement('div');
        _this3.scrollTopSpaceElem.className = 'elx-scroll_top-pace';
        _this3.scrollBottomSpaceElem = document.createElement('div');
        _this3.scrollBottomSpaceElem.className = 'elx-scroll_bottom-pace';

        _this3.bodyWrapperElem.insertBefore(_this3.scrollTopSpaceElem, _this3.tableElem);

        _this3.bodyWrapperElem.insertBefore(_this3.scrollBottomSpaceElem, _this3.tableElem.nextSibling);

        _this3.bodyWrapperElem.addEventListener('scroll', _this3._scrollEvent, false);

        _this3._computeScroll();
      });
    },
     ...
     *   --> 占位
     */
    _scrollEvent: function _scrollEvent(evnt) {
      var _this4 = this;

      var isRender;
      var fullData = this._fullData;
      var renderSize = this.renderSize;
      var scrollTop = this.bodyWrapperElem.scrollTop;
      ...
      if (isRender) {
        var toVisibleStart = toVisibleIndex - renderSize / 2;
        ...
        if (toVisibleStart !== visibleStart) {
          ...
          this.scrollTopSpaceElem.style.height = "".concat(toVisibleStart * rowHeight, "px");
          this.scrollBottomSpaceElem.style.height = "".concat((fullData.length - renderSize - toVisibleStart) * rowHeight, "px");
          this.$nextTick().then(function () {
            _this4.bodyWrapperElem.scrollTop = scrollTop;
          });
        }
      }
    ...
    _computeScroll: function _computeScroll() {
      if (this.scrollLoad) {
        ...
        var visibleSize = Math.ceil(this.bodyWrapperElem.clientHeight / this.rowHeight);

        if (this.configs.size) {
          this.renderSize = this.configs.size;
        } else {
          this.renderSize = visibleSize * (util.browse.msie ? 5 : 10);
        }

        this.offsetSize = visibleSize * 2;
        this.scrollTopSpaceElem.style.height = '0px';
        this.scrollBottomSpaceElem.style.height = "".concat((this._fullData.length - this.renderSize) * this.rowHeight, "px");
      }
    },
    ...
    _handleColumns: function _handleColumns() {
      ...
      if (this.customColumns) {
        this.$nextTick(function () {
          var customColumns = _this5.customColumns && _this5.customColumns.length ? _this5.customColumns : null;
          _this5.columnList = _this5.getColumns().map(function (column) {
          ...
          _this5.isUpdateColumns = true;

          _this5.$emit('update:customColumns', _this5.columnList);
        });
      }
    },
...
var table_column_component = normalizeComponent(
  ...
  table_columnvue_type_template_id_a6180508_render,
  table_columnvue_type_template_id_a6180508_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var editablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    _reloadScrollData: function _reloadScrollData() {
      ...
      this.datas = this._fullData.slice(this.visibleStart, this.visibleStart + this.renderSize);
      return this.$nextTick().then(function () {
        _this7._computeScroll();

        _this7.bodyWrapperElem.scrollTop = 0;
        _this7.bodyWrapperElem.scrollLeft = 0;
      });
    },
    _bindScrollEvent: function _bindScrollEvent() {
      var _this8 = this;
      ...
      return this.$nextTick().then(function () {
        ...
        _this8.scrollTopSpaceElem = document.createElement('div');
        _this8.scrollTopSpaceElem.className = 'elx-scroll_top-pace';
        _this8.scrollBottomSpaceElem = document.createElement('div');
        _this8.scrollBottomSpaceElem.className = 'elx-scroll_bottom-pace';

        _this8.bodyWrapperElem.insertBefore(_this8.scrollTopSpaceElem, _this8.tableElem);

        _this8.bodyWrapperElem.insertBefore(_this8.scrollBottomSpaceElem, _this8.tableElem.nextSibling);

        _this8.bodyWrapperElem.addEventListener('scroll', _this8._scrollEvent, false);

        _this8._computeScroll();
      });
    },
    _unbindScrollEvent: function _unbindScrollEvent() {
      this.bodyWrapperElem.removeChild(this.scrollTopSpaceElem);
    ...
    _scrollEvent: function _scrollEvent(evnt) {
      ...
      if (isRender) {
        ...
        if (toVisibleStart !== visibleStart) {
          ...
          this.scrollBottomSpaceElem.style.height = "".concat((fullData.length - renderSize - toVisibleStart) * rowHeight, "px");
          this.$nextTick().then(function () {
            _this9.bodyWrapperElem.scrollTop = scrollTop;
          });
        }
      }
    ...
    _computeScroll: function _computeScroll() {
      if (this.scrollLoad) {
        ...
        if (this.configs.size) {
          ...
          this.renderSize = visibleSize * (util.browse.msie ? 4 : 6);
        }
    ...
    _setDefaultChecked: function _setDefaultChecked() {
      ...
      this.$nextTick(function () {
        external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.eachTree(_this10.datas, function (row) {
                    ...
                    if (offsetRow) {
                      ...
                      if (this.configs.mode === 'cell' && row.editActive) {
                        ...
                        this._validCellRules('blur', row, column).then(function () {
                          ...
                          return _this11._toValidError(rule, row, column, _cell);
                        });
                      } else {
                        row.checked = null;
                        offsetRow.checked = _offsetColumn.property;
        ...
        if (_row2) {
          ...
          if (_column) {
            ...
            this._triggerActive(_row2, _column, _cell2, event).then(function () {
              if (_this11.configs.checkedEditMethod ? _this11.configs.checkedEditMethod({
                row: _row2.data,
                rowIndex: _rowIndex,
                column: _column,
      ...
      if (disabled) {
        ...
        if (!visibleMethod || visibleMethod(params, evnt)) {
          ...
          this.$nextTick(function () {
            ...
            var clientHeight = _this12.$refs.contextMenu.clientHeight;
            var clientWidth = _this12.$refs.contextMenu.clientWidth;
    ...
    _triggerClear: function _triggerClear(evnt) {
      ...
      if (this.configs.autoClearActive && this.lastActive && (this.callEvent ? this.callEvent.vT < now_default()() : true)) {
        var _ret = function () {
          var clearActiveMethod = _this13.configs.clearActiveMethod;
          var _this13$lastActive = _this13.lastActive,
              row = _this13$lastActive.row,
              column = _this13$lastActive.column,
              cell = _this13$lastActive.cell;

          var rowIndex = _this13._getRowIndex(row);
          ...
          while (target && target.nodeType && target !== document) {
            if (util.hasClass(target, 'elx-editable-row')) {
              ...
              // 如果是同表格
              if (trElem && cellElem && target === _this13.$el) {
          ...
          if (clearActiveMethod) {
            ...
            if (_this13.configs.mode === 'cell') {
              assign_default()(param, {
                column: column,
                columnIndex: _this13._getColumnIndex(column)
              });
            }
    ...
    _cellHandleEvent: function _cellHandleEvent(type, row, column, cell, event) {
      ...
      // 触发顺序 -> clear -> active
      setTimeout(function () {
        if (_this14.configs.trigger !== 'manual' && util.hasClass(cell, 'elx_edit') && (row.editActive ? _this14.configs.mode === 'row' && _this14.lastActive ? _this14.lastActive.column.property !== column.property : _this14.configs.mode === 'cell' && row.editActive !== column.property : true)) {
          _this14._validActiveCell().then(function () {
            ...
            if (_this14.configs.trigger === type) {
              ...
              if (_this14.configs.mode === 'row') {
                _this14._validRowRules('change', row).catch(function (_ref11) {
              ...
              _this14._setChecked(row, column);
            }
          }).catch(function (e) {
            return e;
          }).then(function () {
    ...
    _triggerActive: function _triggerActive(row, column, cell, evnt) {
      ...
      return new promise_default.a(function (resolve, reject) {
        if (!_this15._isDisabledEdit(row, column)) {
          _this15._restoreTooltip(cell);

          _this15._disabledTooltip(cell);

          _this15._clearAllChecked();

          _this15._clearActiveData();
          ...
          _this15.$nextTick(function () {
            _this15._scrollIntoView(cell);

            _this15._setCellFocus(cell);

            if (_this15.configs.mode === 'row') {
              _this15.$emit('edit-active', row.data, evnt);
            } else {
              _this15.$emit('edit-active', row.data, column, cell, evnt);
            }
          ...
          if (_this15.configs.mode === 'row') {
            _this15.$emit('edit-disabled', row.data, evnt);
          } else {
            _this15.$emit('edit-disabled', row.data, column, cell, evnt);
          }
        ...
        this.getColumns().forEach(function (column, columnIndex) {
          if (external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.has(editRules, column.property)) {
            validPromise = validPromise.then(function (rest) {
              return new promise_default.a(function (resolve, reject) {
                _this16._validCellRules('all', row, column).then(resolve).catch(function (rule) {
                  var _this16$_getColumnByR = _this16._getColumnByRowIndex(row.data, column.property),
                      cell = _this16$_getColumnByR.cell;
    ...
    _toActiveRow: function _toActiveRow(record, prop) {
      ...
      if (row && column) {
        ...
        this.datas.forEach(function (row) {
          if (row.data !== record) {
            _this17._clearValidError(row);
          }
        });

        if (prop) {
          this._validCellRules('all', row, column).then(function (valid) {
            return _this17._triggerActive(row, column, cell, {
              type: 'edit',
              trigger: 'call'
            });
          }).catch(function (rule) {
            return _this17._toValidError(rule, row, column, cell);
          });
        } else {
      ...
      if (this.lastActive && !external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isEmpty(this.editRules)) {
        ...
        if (row && this.configs.mode === 'row') {
          return this._validRowRules(row.validActive ? 'all' : 'blur', row).catch(function (_ref13) {
            ...
            _this18._toValidError(rule, row, column, cell);
    ...
    _toValidError: function _toValidError(rule, row, column, cell) {
      ...
      this._triggerActive(row, column, cell, {
        ...
        if (!_this19.configs.useDefaultValidTip) {
        ...
        _this19.$emit('valid-error', rule, row, column, cell);
      });
    },
          ...
          switch (code) {
            ...
            case 'ROW_INSERT':
              this.insertAt(null, row.data).then(function (_ref15) {
                ...
                return _this20._setChecked(_row, column);
              });
              break;
            ...
            case 'ROW_INSERT_ACTIVE':
              this.insertAt(null, row.data).then(function (_ref16) {
                var row = _ref16.row;
                return _this20._toActiveRow(row, column.property);
              });
              break;
    ...
    _handleColumns: function _handleColumns() {
      ...
      if (this.customColumns) {
        this.$nextTick(function () {
          var customColumns = _this21.customColumns && _this21.customColumns.length ? _this21.customColumns : null;
          _this21.columnList = _this21.getColumns().map(function (column) {
            var customItem = customColumns ? customColumns.find(function (item) {
              return column.property && item.prop === column.property;
            }) : null;
            return {
          ...
          _this21.isUpdateColumns = true;

          _this21.$emit('update:customColumns', _this21.columnList);
        });
      }
    },
    ...
    refresh: function refresh(force) {
      ...
      return this.$nextTick().then(function () {
        if (!force && _this22.lastOperation) {
          var expandeKeys = _this22.lastOperation.expandeKeys;
          expandeKeys.forEach(function (key) {
            return _this22.$refs.refElTable.store.toggleTreeExpansion(key);
          });
    ...
    remove: function remove(records) {
      ...
      if (records.length) {
        ...
        records.forEach(function (record) {
          var matchObj = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(_this23._fullData, function (row) {
            return row.data === record;
          }, _this23.elTreeOpts);
          ...
          if (matchObj) {
            ...
            if (removeRow.editStatus === 'initial') {
              _this23.deleteRecords.push(removeRow);
            }
    ...
    getUpdateRecords: function getUpdateRecords() {
      ...
      return this._getData(external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.filterTree(this.datas, function (item) {
        return item.editStatus === 'initial' && !external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isEqualWith(assign_default()({}, item.data, {
          ...
          if (key === _this24.elTreeOpts.children) {
            return true;
          }
        });
      }), this.elTreeOpts);
    ...
    updateStatus: function updateStatus(scope) {
      ...
      return this.$nextTick().then(function () {
        if (scope) {
          ...
          var _this25$_getColumnByR = _this25._getColumnByRowIndex(record, column.property),
              row = _this25$_getColumnByR.row,
              cell = _this25$_getColumnByR.cell;

          if (cell) {
            return _this25._validCellRules('change', row, column).then(function (rule) {
              if (_this25.configs.mode === 'row' ? row.validActive && row.validActive === column.property : true) {
                _this25._clearValidError(row);
              }
            }).catch(function (rule) {
              return _this25._toValidError(rule, row, column, cell);
            }).then(function () {
    ...
    validateRow: function validateRow(record, cb) {
      ...
      return new promise_default.a(function (resolve, reject) {
        var matchObj = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(_this26.datas, function (row) {
          return row.data === record;
        }, _this26.elTreeOpts);
        var row = matchObj.item;
              ...
              validPromise = validPromise.then(function (rest) {
                return new promise_default.a(function (resolve, reject) {
                  _this27._validCellRules('all', row, column).then(resolve).catch(function (rule) {
                    var _this27$_getColumnByR = _this27._getColumnByRowIndex(row.data, column.property),
...
var editable_component = normalizeComponent(
  ...
  editablevue_type_template_id_4c9aaa88_render,
  editablevue_type_template_id_4c9aaa88_staticRenderFns,
  false,
  null,
  null,
  null
