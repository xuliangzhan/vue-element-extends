<template>
  <div v-loading="loading">
    ...
    <el-form ref="tableform" class="dblclick-table5-form" size="mini" :inline="true" :model="formData">
    ...
    <div class="dblclick-table5-oper">
...
<style>
.dblclick-table5-oper {
  margin-bottom: 18px;
}
.dblclick-table5 .delete-row {
  color: #f56c6c;
  text-decoration: line-through;
}
.dblclick-table5-pagination {
  margin-top: 18px;
  text-align: right;
}
.dblclick-table5.elx-editable .elx-editable-row.new-insert,
.dblclick-table5.elx-editable .elx-editable-row.new-insert:hover>td {
