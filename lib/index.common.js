    ...
    updateStatus: function updateStatus(scope) {
      ...
      return this.$nextTick().then(function () {
        if (scope) {
          ...
          if (cell) {
            return _this24._validCellRules('change', row, column).then(function (rule) {
...
var editable_component = normalizeComponent(
  ...
  editablevue_type_template_id_16326a83_render,
  editablevue_type_template_id_16326a83_staticRenderFns,
  false,
  null,
  null,
  null
