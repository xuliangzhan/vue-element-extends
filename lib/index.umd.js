  ...
  methods: {
    ...
    remove: function remove(records) {
      ...
      if (records.length) {
        ...
        records.forEach(function (record) {
          var matchObj = external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.findTree(_this22.datas, function (row) {
            return row.data === record;
          }, _this22.elTreeOpts);
...
var editable_component = normalizeComponent(
  ...
  editablevue_type_template_id_62f3e254_render,
  editablevue_type_template_id_62f3e254_staticRenderFns,
  false,
  null,
  null,
  null
