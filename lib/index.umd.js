...
// CONCATENATED MODULE: ./packages/editable/src/editable.vue?vue&type=template&id=26ac6c76&
      ...
      if (records && records.length) {
        ...
        records.forEach(function (record) {
          ...
          if (matchObj) {
            ...
            var removeRow = items.splice(index, 1);
