...
// CONCATENATED MODULE: ./packages/table/src/table.vue?vue&type=template&id=5fc424f2&
...
var UtilHandle = {
  ...
  getCsvContent: function getCsvContent(opts, csvData) {
...
/* harmony default export */ var tablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    _getTableLabelData: function _getTableLabelData(columns) {
    ...
    _getCsvData: function _getCsvData(opts) {
      ...
      var datas = opts.data ? opts.data : isOriginal ? this.data : this._getTableLabelData(columns);
    ...
    exportCsv: function exportCsv(options) {
      ...
      util.downloadCsc(opts, util.getCsvContent(opts, this._getCsvData(opts)));
    }
    /******************************/
...
var table_column_component = normalizeComponent(
  ...
  table_columnvue_type_template_id_2349be02_render,
  table_columnvue_type_template_id_2349be02_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var editablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    _getCsvData: function _getCsvData(opts) {
      ...
      var datas = opts.data ? opts.data : isOriginal ? this._getData(this._getTDatas()) : this._getTableLabelData(columns);
...
var editable_component = normalizeComponent(
  ...
  editablevue_type_template_id_aece8a28_render,
  editablevue_type_template_id_aece8a28_staticRenderFns,
  false,
  null,
  null,
  null
