...
// CONCATENATED MODULE: ./packages/editable/src/editable.vue?vue&type=template&id=3f66314e&
      ...
      if (this.configs.autoClearActive) {
        if (!this.callEvent && this.lastActive) {
          ...
          while (target && target.nodeType && target !== document) {
            ...
            if (this.configs.mode === 'row' ? this._hasClass(target, 'editable-row') && this._getIndex(from_default()(target.parentNode.children), target) !== rowIndex : this._hasClass(target, 'editable-column')) {
              type = 'in';
            }
...
var editable_column_component = normalizeComponent(
  ...
  editable_columnvue_type_template_id_350c48d0_render,
  editable_columnvue_type_template_id_350c48d0_staticRenderFns,
  false,
  null,
  null,
  null
