<template>
  <div v-loading="loading">
    ...
    <elx-editable
      ...
      style="width: 100%">
      <elx-editable-column type="selection" width="55" :selectable="selectableEvent"></elx-editable-column>
      <elx-editable-column prop="id" label="ID" width="80"></elx-editable-column>
      <elx-editable-column prop="name" label="名字" show-overflow-tooltip :edit-render="{type: 'default', autofocus: true}">
...
.click-table3.elx-editable .elx-editable-row.new-insert,
.click-table3.elx-editable .elx-editable-row.new-insert:hover>td {
