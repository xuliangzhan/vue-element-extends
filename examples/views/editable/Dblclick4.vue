<template>
  <div v-loading="loading">
    ...
    <elx-editable
      ...
      <elx-editable-column prop="describe" label="备注" show-overflow-tooltip :edit-render="{name: 'ElInput', props: {type: 'textarea', autosize: {minRows: 1, maxRows: 4}}}"></elx-editable-column>
