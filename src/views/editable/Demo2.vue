<template>
  <div v-loading="loading">
    ...
    <el-editable ref="editable">
      ...
      <el-editable-column prop="sex" label="性别" width="70" :editRender="{name: 'ElSelect', options: sexList}"></el-editable-column>
      <el-editable-column prop="age" label="年龄" width="70" :editRender="{name: 'ElInputNumber', attrs: {min: 1, max: 200}}"></el-editable-column>
